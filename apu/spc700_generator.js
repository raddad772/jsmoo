...
const SPC_AM = Object.freeze({
    ...
    RA_IMM: 23,  // A, #imm
    RA_IND_X: 24, // A, (X)
    RA_IND_INDEXED_X: 25, // A, [d+X]
    RA_IND_Y_INDEXED: 26, // A, [d]+Y
    RA_DP: 27, // A, dp
    RA_DP_X: 28, // A, dp+X
    RA_A: 29, // A, !abs
    RA_A_X: 30, // A, !abs+X
...
const SPC_INS = Object.freeze({
    ...
    0x02: new SPC_OP_INFO(0x02, 'SET1', 'd.0', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0x03: new SPC_OP_INFO(0x03, 'BBS', 'd.0, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    0x04: new SPC_OP_INFO(0x04, 'OR', 'A, d', SPC_MN.OR, SPC_AM.RA_DP, 3), // X
    ...
    0x0D: new SPC_OP_INFO(0x0D, 'PUSH', 'PSW', SPC_MN.PUSH, SPC_AM.STACK, 4),
    ...
    0x12: new SPC_OP_INFO(0x12, 'CLR1', 'd.0', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0x13: new SPC_OP_INFO(0x13, 'BBC', 'd.0', SPC_MN.BBC, SPC_AM.PC_R_BIT, 5), // X
    0x14: new SPC_OP_INFO(0x14, 'OR', 'A, d+X', SPC_MN.OR, SPC_AM.RA_DP_X, 4),
    ...
    0x17: new SPC_OP_INFO(0x17, 'OR', 'A, [d]+Y', SPC_MN.OR, SPC_AM.RA_IND_Y_INDEXED, 6),
    0x18: new SPC_OP_INFO(0x18, 'OR', 'dp, #imm', SPC_MN.OR, SPC_AM.DP_IMM, 5),
    0x1A: new SPC_OP_INFO(0x1A, 'DECW', 'dp', SPC_MN.DECW, SPC_AM.DPW, 6),
    0x1B: new SPC_OP_INFO(0x1B, 'ASL', 'd+X', SPC_MN.ASL, SPC_AM.DP_INDEXED_X, 5),
    ...
    0x22: new SPC_OP_INFO(0x22, 'SET1', 'd.1', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0x23: new SPC_OP_INFO(0x23, 'BBS', 'd.1, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    ...
    0x27: new SPC_OP_INFO(0x27, 'AND', 'A, [d+X]', SPC_MN.AND, SPC_AM.RA_IND_INDEXED_X, 6),
    ...
    0x32: new SPC_OP_INFO(0x32, 'CLR1', 'd.1', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0x33: new SPC_OP_INFO(0x33, 'BBC', 'd.1', SPC_MN.BBC, SPC_AM.PC_R_BIT, 5), // X
    0x34: new SPC_OP_INFO(0x34, 'AND', 'A, d+X', SPC_MN.AND, SPC_AM.RA_DP_X, 4),
    ...
    0x37: new SPC_OP_INFO(0x37, 'AND', 'A, [d]+Y', SPC_MN.AND, SPC_AM.RA_IND_Y_INDEXED, 6),
    ...
    0x3F: new SPC_OP_INFO(0x3F, 'CALL', '!abs', SPC_MN.CALL, SPC_AM.A, 8),
    0x40: new SPC_OP_INFO(0x40, 'SETP', 'i', SPC_MN.SETP, SPC_AM.I, 2),
    0x41: new SPC_OP_INFO(0x41, 'TCALL', '4', SPC_MN.TCALL, SPC_AM.I, 8),
    0x42: new SPC_OP_INFO(0x42, 'SET1', 'd.2', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0x43: new SPC_OP_INFO(0x43, 'BBS', 'd.2, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    ...
    0x52: new SPC_OP_INFO(0x52, 'CLR1', 'd.2', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0x53: new SPC_OP_INFO(0x53, 'BBC', 'd.2', SPC_MN.BBC, SPC_AM.PC_R_BIT, 5), // X
    ...
    0x57: new SPC_OP_INFO(0x57, 'EOR', 'A, [d]+Y', SPC_MN.EOR, SPC_AM.RA_IND_Y_INDEXED, 6),
    ...
    0x5B: new SPC_OP_INFO(0x5B, 'LSR', 'd+X', SPC_MN.LSR, SPC_AM.DP_INDEXED_X, 5),
    ...
    0x62: new SPC_OP_INFO(0x62, 'SET1', 'd.3', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0x63: new SPC_OP_INFO(0x63, 'BBS', 'd.3, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    0x64: new SPC_OP_INFO(0x64, 'CMP', 'A, d', SPC_MN.CMP, SPC_AM.RA_DP, 3),
    ...
    0x72: new SPC_OP_INFO(0x72, 'CLR1', 'd.3', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0x73: new SPC_OP_INFO(0x73, 'BBC', 'd.3', SPC_MN.BBC, SPC_AM.PC_R_BIT, 5), // X
    ...
    0x77: new SPC_OP_INFO(0x77, 'CMP', 'A, [d]+Y', SPC_MN.CMP, SPC_AM.RA_IND_Y_INDEXED, 6),
    0x79: new SPC_OP_INFO(0x79, 'CMP', '(X), (Y)', SPC_MN.CMP, SPC_AM.IND_XY, 5),
    0x7A: new SPC_OP_INFO(0x7A, 'ADDW', 'YA, d', SPC_MN.ADDW, SPC_AM.YA_DP, 5),
    ...
    0x82: new SPC_OP_INFO(0x82, 'SET1', 'd.4', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0x83: new SPC_OP_INFO(0x83, 'BBS', 'd.4, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    ...
    0x87: new SPC_OP_INFO(0x87, 'ADC', 'A, [d+X]', SPC_MN.ADC, SPC_AM.RA_IND_INDEXED_X, 6),
    ...
    0x8E: new SPC_OP_INFO(0x8E, 'POP', 'PSW', SPC_MN.POP, SPC_AM.STACK, 4),
    0x90: new SPC_OP_INFO(0x90, 'BCC', 'r', SPC_MN.BCC, SPC_AM.PC_R, 2),
    0x91: new SPC_OP_INFO(0x91, 'TCALL', '9', SPC_MN.TCALL, SPC_AM.I, 8),
    0x92: new SPC_OP_INFO(0x92, 'CLR1', 'd.4', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0x93: new SPC_OP_INFO(0x93, 'BBC', 'd.4', SPC_MN.BBC, SPC_AM.PC_R_BIT, 5), // X
    ...
    0x97: new SPC_OP_INFO(0x97, 'ADC', 'A, [d]+Y', SPC_MN.ADC, SPC_AM.RA_IND_Y_INDEXED, 6),
    ...
    0x9A: new SPC_OP_INFO(0x9A, 'SUBW', 'YA, d', SPC_MN.SUBW, SPC_AM.YA_DP, 5),
    ...
    0xA2: new SPC_OP_INFO(0xA2, 'SET1', 'd.5', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0xA3: new SPC_OP_INFO(0xA3, 'BBS', 'd.5, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    ...
    0xA7: new SPC_OP_INFO(0xA7, 'SBC', 'A, [d+X]', SPC_MN.SBC, SPC_AM.RA_IND_INDEXED_X, 6),
    ...
    0xB2: new SPC_OP_INFO(0xB2, 'CLR1', 'd.5', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0xB3: new SPC_OP_INFO(0xB3, 'BBC', 'd.5', SPC_MN.BBC, SPC_AM.PC_R_BIT, 5), // X
    ...
    0xB7: new SPC_OP_INFO(0xB7, 'SBC', 'A, [d]+Y', SPC_MN.SBC, SPC_AM.RA_IND_Y_INDEXED, 6),
    ...
    0xC2: new SPC_OP_INFO(0xC2, 'SET1', 'd.6', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0xC3: new SPC_OP_INFO(0xC3, 'BBS', 'd.6, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    0xC5: new SPC_OP_INFO(0xC5, 'MOV', '!abs, A', SPC_MN.MOV, SPC_AM.MOV, 5),
    0xC7: new SPC_OP_INFO(0xC7, 'MOV', '[d+X], A', SPC_MN.MOV, SPC_AM.MOV, 7),
    ...
    0xD2: new SPC_OP_INFO(0xD2, 'CLR1', 'd.6', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0xD3: new SPC_OP_INFO(0xD3, 'BBC', 'd.6', SPC_MN.BBC, SPC_AM.PC_R_BIT, 5),
    0xD4: new SPC_OP_INFO(0xD4, 'MOV', 'd+X, A', SPC_MN.MOV, SPC_AM.MOV, 5),
    ...
    0xD8: new SPC_OP_INFO(0xD8, 'MOV', 'd, X', SPC_MN.MOV, SPC_AM.MOV, 4),
    0xD9: new SPC_OP_INFO(0xD9, 'MOV', 'd+Y, X', SPC_MN.MOV, SPC_AM.MOV, 5),
    ...
    0xE2: new SPC_OP_INFO(0xE2, 'SET1', 'd.7', SPC_MN.SET1, SPC_AM.D_BIT, 4), // X
    0xE3: new SPC_OP_INFO(0xE3, 'BBS', 'd.7, r', SPC_MN.BBS, SPC_AM.PC_R_BIT, 5), // X
    0xE5: new SPC_OP_INFO(0xE5, 'MOV', 'A, !abs', SPC_MN.MOV, SPC_AM.MOV, 4),
    0xE6: new SPC_OP_INFO(0xE6, 'MOV', 'A, (X)', SPC_MN.MOV, SPC_AM.MOV, 3),
    0xE7: new SPC_OP_INFO(0xE7, 'MOV', 'A, [d+X]', SPC_MN.MOV, SPC_AM.MOV, 6),
    ...
    0xF2: new SPC_OP_INFO(0xF2, 'CLR1', 'd.7', SPC_MN.CLR1, SPC_AM.D_BIT, 4), // X
    0xF7: new SPC_OP_INFO(0xF7, 'MOV', 'A, [d]+Y', SPC_MN.MOV, SPC_AM.MOV, 6),
