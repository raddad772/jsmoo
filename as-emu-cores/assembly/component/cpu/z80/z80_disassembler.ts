...
import {Z80_S_DECODE, Z80_S_RESET} from "./z80_opcodes";

/* Z80 instruction decoding adapted from algorithm at
    http://www.z80.info/decoding.htm
 */

const Z80D_tabl_r: StaticArray<string> = ['B', 'C', 'D', 'E', 'H', 'L', '(HL)', 'A'];
const Z80D_tabl_rp: StaticArray<string>  = ['BC', 'DE', 'HL', 'SP'];
const Z80D_tabl_rp2: StaticArray<string>  = ['BC', 'DE', 'HL', 'AF'];
const Z80D_tabl_cc: StaticArray<string>  = ['NZ', 'Z', 'NC', 'C', 'PO', 'PE', 'P', 'M'];
const Z80D_tabl_alu: StaticArray<string>  = ['ADD A, ', 'ADC A, ', 'SUB', 'SBC A, ', 'AND', 'XOR', 'OR', 'CP'];
const Z80D_tabl_rot: StaticArray<string>  = ['RLC', 'RRC', 'RL', 'RR', 'SLA', 'SRA', 'SSL', 'SRL'];
const Z80D_tabl_im: StaticArray<string>  = ['0', '0/1', '1', '2', '0', '0/1', '1', '2'];
const Z80D_tabl_bli: StaticArray<StaticArray<string>>  = [[], [], [], [],
...
function Z80_disassemble(PC: u32, IR: u32): string {
    let opcode = IR;
