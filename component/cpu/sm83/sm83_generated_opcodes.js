...
const sm83_decoded_opcodes = Object.freeze({
    ...
    0x01: new SM83_opcode_functions(SM83_opcode_matrix[0x01], // 01
        ...
        switch(regs.TCU) {
            ...
            case 3: // cleanup_custom
                regs.RR = pins.D; // DELAYED
                regs.TR |= (regs.RR << 8); // DELAYED
                regs.B = (regs.TR & 0xFF00) >>> 8; // DELAYED
                regs.C = regs.TR & 0xFF; // DELAYED
    ...
    0x04: new SM83_opcode_functions(SM83_opcode_matrix[0x04], // 04
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.B = ((regs.B) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.B) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
    ...
    0x05: new SM83_opcode_functions(SM83_opcode_matrix[0x05], // 05
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.B = ((regs.B) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.B) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.B) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x07: new SM83_opcode_functions(SM83_opcode_matrix[0x07], // 07
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.A = ((regs.A << 1) | (regs.A >>> 7)) & 0xFF; // DELAYED
                regs.F.C = regs.A & 1; // DELAYED
    ...
    0x0C: new SM83_opcode_functions(SM83_opcode_matrix[0x0C], // 0C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.C = ((regs.C) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.C) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
    ...
    0x0D: new SM83_opcode_functions(SM83_opcode_matrix[0x0D], // 0D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.C = ((regs.C) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.C) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.C) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x0F: new SM83_opcode_functions(SM83_opcode_matrix[0x0F], // 0F
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.A = (((regs.A) << 7) | ((regs.A) >>> 1)) & 0xFF; // DELAYED
                regs.F.C = ((regs.A) & 0x80) >>> 7; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.A) === 0); // DELAYED
                regs.F.Z = 0; // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x11: new SM83_opcode_functions(SM83_opcode_matrix[0x11], // 11
        ...
        switch(regs.TCU) {
            ...
            case 3: // cleanup_custom
                regs.RR = pins.D; // DELAYED
                regs.TR |= (regs.RR << 8); // DELAYED
                regs.D = (regs.TR & 0xFF00) >>> 8; // DELAYED
                regs.E = regs.TR & 0xFF; // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
                regs.PC = (regs.PC + 1) & 0xFFFF;
                regs.TCU = 0;
    ...
    0x14: new SM83_opcode_functions(SM83_opcode_matrix[0x14], // 14
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.D = ((regs.D) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.D) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
    ...
    0x15: new SM83_opcode_functions(SM83_opcode_matrix[0x15], // 15
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.D = ((regs.D) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.D) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.D) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x17: new SM83_opcode_functions(SM83_opcode_matrix[0x17], // 17
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let carry = ((regs.A) & 0x80) >>> 7; // DELAYED
                regs.A = (((regs.A) << 1) & 0xFE) | regs.F.C; // DELAYED
    ...
    0x1C: new SM83_opcode_functions(SM83_opcode_matrix[0x1C], // 1C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.E = ((regs.E) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.E) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
    ...
    0x1D: new SM83_opcode_functions(SM83_opcode_matrix[0x1D], // 1D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.E = ((regs.E) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.E) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.E) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x1F: new SM83_opcode_functions(SM83_opcode_matrix[0x1F], // 1F
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                ...
                regs.A = ((regs.A) >>> 1) | (regs.F.C << 7); // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.A) === 0); // DELAYED
                regs.F.Z = 0; // DELAYED
    ...
    0x21: new SM83_opcode_functions(SM83_opcode_matrix[0x21], // 21
        ...
        switch(regs.TCU) {
            ...
            case 3: // cleanup_custom
                regs.RR = pins.D; // DELAYED
                regs.TR |= (regs.RR << 8); // DELAYED
                regs.H = (regs.TR & 0xFF00) >>> 8; // DELAYED
                regs.L = regs.TR & 0xFF; // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
                regs.PC = (regs.PC + 1) & 0xFFFF;
                regs.TCU = 0;
    ...
    0x24: new SM83_opcode_functions(SM83_opcode_matrix[0x24], // 24
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.H = ((regs.H) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.H) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
    ...
    0x25: new SM83_opcode_functions(SM83_opcode_matrix[0x25], // 25
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.H = ((regs.H) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.H) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.H) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x27: new SM83_opcode_functions(SM83_opcode_matrix[0x27], // 27
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let a = regs.A; // DELAYED
                if (!regs.F.N) { // DELAYED
                    if (regs.F.H || ((regs.A & 0x0F) > 0x09)) a += 0x06; // DELAYED
                    if (regs.F.C || (regs.A > 0x99)) { // DELAYED
                        a += 0x60; // DELAYED
                        regs.F.C = 1; // DELAYED
                    } // DELAYED
                } else { // DELAYED
                    a -= (0x06 * regs.F.H); // DELAYED
                    a -= (0x60 * regs.F.C); // DELAYED
                } // DELAYED
                regs.A = a & 0xFF; // DELAYED
                regs.F.H = 0; // DELAYED
                regs.F.Z = +((regs.A) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x2C: new SM83_opcode_functions(SM83_opcode_matrix[0x2C], // 2C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.L = ((regs.L) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.L) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
    ...
    0x2D: new SM83_opcode_functions(SM83_opcode_matrix[0x2D], // 2D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.L = ((regs.L) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.L) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.L) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x34: new SM83_opcode_functions(SM83_opcode_matrix[0x34], // 34
        ...
        switch(regs.TCU) {
            ...
            case 2: // Do write
                regs.TR = pins.D; // DELAYED
                regs.TR = ((regs.TR) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.TR) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
    ...
    0x35: new SM83_opcode_functions(SM83_opcode_matrix[0x35], // 35
        ...
        switch(regs.TCU) {
            ...
            case 2: // Do write
                regs.TR = pins.D; // DELAYED
                regs.TR = ((regs.TR) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.TR) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.TR) === 0); // DELAYED
                pins.Addr = (regs.TA);
                pins.D = regs.TR;
    ...
    0x3C: new SM83_opcode_functions(SM83_opcode_matrix[0x3C], // 3C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.A = ((regs.A) + 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.A) & 0x0F) === 0); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.A) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x3D: new SM83_opcode_functions(SM83_opcode_matrix[0x3D], // 3D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.A = ((regs.A) - 1) & 0xFF; // DELAYED
                regs.F.H = +(((regs.A) & 0x0F) === 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.F.Z = +((regs.A) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x80: new SM83_opcode_functions(SM83_opcode_matrix[0x80], // 80
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.B); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.B) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
                regs.F.Z = +((regs.TR) === 0); // DELAYED
                regs.A = regs.TR; // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x81: new SM83_opcode_functions(SM83_opcode_matrix[0x81], // 81
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.C); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.C) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x82: new SM83_opcode_functions(SM83_opcode_matrix[0x82], // 82
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.D); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.D) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x83: new SM83_opcode_functions(SM83_opcode_matrix[0x83], // 83
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.E); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.E) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x84: new SM83_opcode_functions(SM83_opcode_matrix[0x84], // 84
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.H); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.H) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x85: new SM83_opcode_functions(SM83_opcode_matrix[0x85], // 85
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.L); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.L) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x86: new SM83_opcode_functions(SM83_opcode_matrix[0x86], // 86
        ...
        switch(regs.TCU) {
            ...
            case 2: // cleanup_custom
                regs.TR = pins.D; // DELAYED
                let x = (regs.A) + (regs.TR); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.TR) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x87: new SM83_opcode_functions(SM83_opcode_matrix[0x87], // 87
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.A); // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.A) & 0x0F); // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x88: new SM83_opcode_functions(SM83_opcode_matrix[0x88], // 88
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.B) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.B) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x89: new SM83_opcode_functions(SM83_opcode_matrix[0x89], // 89
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.C) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.C) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x8A: new SM83_opcode_functions(SM83_opcode_matrix[0x8A], // 8A
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.D) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.D) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x8B: new SM83_opcode_functions(SM83_opcode_matrix[0x8B], // 8B
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.E) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.E) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x8C: new SM83_opcode_functions(SM83_opcode_matrix[0x8C], // 8C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.H) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.H) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x8D: new SM83_opcode_functions(SM83_opcode_matrix[0x8D], // 8D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.L) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.L) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x8E: new SM83_opcode_functions(SM83_opcode_matrix[0x8E], // 8E
        ...
        switch(regs.TCU) {
            ...
            case 2: // cleanup_custom
                regs.TR = pins.D; // DELAYED
                let x = (regs.A) + (regs.TR) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.TR) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x8F: new SM83_opcode_functions(SM83_opcode_matrix[0x8F], // 8F
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = (regs.A) + (regs.A) + regs.F.C; // DELAYED
                let y = ((regs.A) & 0x0F) + ((regs.A) & 0x0F) + regs.F.C; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 0; // DELAYED
                regs.TR = (x & 0xFF); // DELAYED
    ...
    0x90: new SM83_opcode_functions(SM83_opcode_matrix[0x90], // 90
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.B)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.B) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x91: new SM83_opcode_functions(SM83_opcode_matrix[0x91], // 91
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.C)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.C) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x92: new SM83_opcode_functions(SM83_opcode_matrix[0x92], // 92
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.D)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.D) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x93: new SM83_opcode_functions(SM83_opcode_matrix[0x93], // 93
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.E)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.E) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x94: new SM83_opcode_functions(SM83_opcode_matrix[0x94], // 94
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.H)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.H) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x95: new SM83_opcode_functions(SM83_opcode_matrix[0x95], // 95
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.L)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.L) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x96: new SM83_opcode_functions(SM83_opcode_matrix[0x96], // 96
        ...
        switch(regs.TCU) {
            ...
            case 2: // cleanup_custom
                regs.TR = pins.D; // DELAYED
                let x = ((regs.A) - (regs.TR)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.TR) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x97: new SM83_opcode_functions(SM83_opcode_matrix[0x97], // 97
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.A)) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.A) & 0x0F)) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x98: new SM83_opcode_functions(SM83_opcode_matrix[0x98], // 98
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.B) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.B) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x99: new SM83_opcode_functions(SM83_opcode_matrix[0x99], // 99
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.C) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.C) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x9A: new SM83_opcode_functions(SM83_opcode_matrix[0x9A], // 9A
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.D) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.D) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x9B: new SM83_opcode_functions(SM83_opcode_matrix[0x9B], // 9B
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.E) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.E) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x9C: new SM83_opcode_functions(SM83_opcode_matrix[0x9C], // 9C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.H) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.H) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x9D: new SM83_opcode_functions(SM83_opcode_matrix[0x9D], // 9D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.L) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.L) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x9E: new SM83_opcode_functions(SM83_opcode_matrix[0x9E], // 9E
        ...
        switch(regs.TCU) {
            ...
            case 2: // cleanup_custom
                regs.TR = pins.D; // DELAYED
                let x = ((regs.A) - (regs.TR) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.TR) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0x9F: new SM83_opcode_functions(SM83_opcode_matrix[0x9F], // 9F
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let x = ((regs.A) - (regs.A) - regs.F.C) & 0xFFFF; // DELAYED
                let y = (((regs.A) & 0x0F) - ((regs.A) &0x0F) - regs.F.C) & 0xFFFF; // DELAYED
                regs.F.C = +(x > 0xFF); // DELAYED
                regs.F.H = +(y > 0x0F); // DELAYED
                regs.F.N = 1; // DELAYED
                regs.TR = x & 0xFF; // DELAYED
    ...
    0xA0: new SM83_opcode_functions(SM83_opcode_matrix[0xA0], // A0
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.TR = (regs.A) & (regs.B); // DELAYED
                regs.F.C = regs.F.N = 0; // DELAYED
                regs.F.H = 1; // DELAYED
                regs.F.Z = +((regs.TR) === 0); // DELAYED
                regs.A = regs.TR; // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0xA6: new SM83_opcode_functions(SM83_opcode_matrix[0xA6], // A6
        ...
        switch(regs.TCU) {
            ...
            case 2: // cleanup_custom
                regs.TR = pins.D; // DELAYED
                regs.TR = (regs.A) & (regs.TR); // DELAYED
                regs.F.C = regs.F.N = 0; // DELAYED
                regs.F.H = 1; // DELAYED
                regs.F.Z = +((regs.TR) === 0); // DELAYED
                regs.A = regs.TR; // DELAYED
    ...
    0xA8: new SM83_opcode_functions(SM83_opcode_matrix[0xA8], // A8
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.TR = (regs.A) ^ (regs.B); // DELAYED
                regs.F.C = regs.F.N = regs.F.H = 0; // DELAYED
                regs.F.Z = +((regs.TR) === 0); // DELAYED
                regs.A = regs.TR; // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0xC2: new SM83_opcode_functions(SM83_opcode_matrix[0xC2], // C2
        ...
        switch(regs.TCU) {
            ...
            case 3:
                regs.RR = pins.D; // DELAYED
                regs.TA |= (regs.RR << 8); // DELAYED
                if (!(regs.F.Z === 0)) { regs.TCU += 1; break; } // CHECKHERE // DELAYED
                regs.PC = regs.TA;
                // Following is auto-generated code for instruction finish
                pins.RD = 0; pins.MRQ = 0;
                break;
    ...
    0xC3: new SM83_opcode_functions(SM83_opcode_matrix[0xC3], // C3
        ...
        switch(regs.TCU) {
            ...
            case 3:
                regs.RR = pins.D; // DELAYED
                regs.TA |= (regs.RR << 8); // DELAYED
                if (!(1)) { regs.TCU += 1; break; } // CHECKHERE // DELAYED
                regs.PC = regs.TA;
                // Following is auto-generated code for instruction finish
                pins.RD = 0; pins.MRQ = 0;
                break;
    ...
    0xCA: new SM83_opcode_functions(SM83_opcode_matrix[0xCA], // CA
        ...
        switch(regs.TCU) {
            ...
            case 3:
                regs.RR = pins.D; // DELAYED
                regs.TA |= (regs.RR << 8); // DELAYED
                if (!(regs.F.Z === 1)) { regs.TCU += 1; break; } // CHECKHERE // DELAYED
                regs.PC = regs.TA;
                // Following is auto-generated code for instruction finish
                pins.RD = 0; pins.MRQ = 0;
                break;
    ...
    0xCD: new SM83_opcode_functions(SM83_opcode_matrix[0xCD], // CD
        ...
        switch(regs.TCU) {
            ...
            case 3:
                regs.RR = pins.D; // DELAYED
                regs.TA |= (regs.RR << 8); // DELAYED
                if (!(1)) { regs.TCU += 3; break; } // CHECKHERE // DELAYED
                regs.SP = (regs.SP - 1) & 0xFFFF;
                pins.RD = 0; pins.MRQ = 0;
                break;
            case 4: // Do write
    ...
    0xD2: new SM83_opcode_functions(SM83_opcode_matrix[0xD2], // D2
        ...
        switch(regs.TCU) {
            ...
            case 3:
                regs.RR = pins.D; // DELAYED
                regs.TA |= (regs.RR << 8); // DELAYED
                if (!(regs.F.C === 0)) { regs.TCU += 1; break; } // CHECKHERE // DELAYED
                regs.PC = regs.TA;
                // Following is auto-generated code for instruction finish
                pins.RD = 0; pins.MRQ = 0;
                break;
    ...
    0xDA: new SM83_opcode_functions(SM83_opcode_matrix[0xDA], // DA
        ...
        switch(regs.TCU) {
            ...
            case 3:
                regs.RR = pins.D; // DELAYED
                regs.TA |= (regs.RR << 8); // DELAYED
                if (!(regs.F.C === 1)) { regs.TCU += 1; break; } // CHECKHERE // DELAYED
                regs.PC = regs.TA;
                // Following is auto-generated code for instruction finish
                pins.RD = 0; pins.MRQ = 0;
                break;
    ...
    0xE9: new SM83_opcode_functions(SM83_opcode_matrix[0xE9], // E9
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.PC = (regs.H << 8) | regs.L; // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
                regs.PC = (regs.PC + 1) & 0xFFFF;
                regs.TCU = 0;
    ...
    0xF1: new SM83_opcode_functions(SM83_opcode_matrix[0xF1], // F1
        ...
        switch(regs.TCU) {
            ...
            case 2: // Do read
                regs.TR = pins.D; // DELAYED
                regs.F.setbyte(regs.TR & 0xF0); // DELAYED
                regs.SP = (regs.SP + 1) & 0xFFFF; // DELAYED
                pins.Addr = (regs.SP);
                regs.SP = (regs.SP + 1) & 0xFFFF;
                // Following is auto-generated code for instruction finish
                break;
    ...
    0x102: new SM83_opcode_functions(SM83_opcode_matrixCB[0x00], // CB 00
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.B = ((regs.B << 1) | (regs.B >>> 7)) & 0xFF; // DELAYED
                regs.F.C = regs.B & 1; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.B) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x103: new SM83_opcode_functions(SM83_opcode_matrixCB[0x01], // CB 01
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.C = ((regs.C << 1) | (regs.C >>> 7)) & 0xFF; // DELAYED
                regs.F.C = regs.C & 1; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.C) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x104: new SM83_opcode_functions(SM83_opcode_matrixCB[0x02], // CB 02
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.D = ((regs.D << 1) | (regs.D >>> 7)) & 0xFF; // DELAYED
                regs.F.C = regs.D & 1; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.D) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x105: new SM83_opcode_functions(SM83_opcode_matrixCB[0x03], // CB 03
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.E = ((regs.E << 1) | (regs.E >>> 7)) & 0xFF; // DELAYED
                regs.F.C = regs.E & 1; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.E) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x106: new SM83_opcode_functions(SM83_opcode_matrixCB[0x04], // CB 04
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.H = ((regs.H << 1) | (regs.H >>> 7)) & 0xFF; // DELAYED
                regs.F.C = regs.H & 1; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.H) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x107: new SM83_opcode_functions(SM83_opcode_matrixCB[0x05], // CB 05
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.L = ((regs.L << 1) | (regs.L >>> 7)) & 0xFF; // DELAYED
                regs.F.C = regs.L & 1; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.L) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x10A: new SM83_opcode_functions(SM83_opcode_matrixCB[0x08], // CB 08
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.B = (((regs.B) << 7) | ((regs.B) >>> 1)) & 0xFF; // DELAYED
                regs.F.C = ((regs.B) & 0x80) >>> 7; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.B) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x10B: new SM83_opcode_functions(SM83_opcode_matrixCB[0x09], // CB 09
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.C = (((regs.C) << 7) | ((regs.C) >>> 1)) & 0xFF; // DELAYED
                regs.F.C = ((regs.C) & 0x80) >>> 7; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.C) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x10C: new SM83_opcode_functions(SM83_opcode_matrixCB[0x0A], // CB 0A
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.D = (((regs.D) << 7) | ((regs.D) >>> 1)) & 0xFF; // DELAYED
                regs.F.C = ((regs.D) & 0x80) >>> 7; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.D) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x10D: new SM83_opcode_functions(SM83_opcode_matrixCB[0x0B], // CB 0B
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.E = (((regs.E) << 7) | ((regs.E) >>> 1)) & 0xFF; // DELAYED
                regs.F.C = ((regs.E) & 0x80) >>> 7; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.E) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x10E: new SM83_opcode_functions(SM83_opcode_matrixCB[0x0C], // CB 0C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.H = (((regs.H) << 7) | ((regs.H) >>> 1)) & 0xFF; // DELAYED
                regs.F.C = ((regs.H) & 0x80) >>> 7; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.H) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x10F: new SM83_opcode_functions(SM83_opcode_matrixCB[0x0D], // CB 0D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.L = (((regs.L) << 7) | ((regs.L) >>> 1)) & 0xFF; // DELAYED
                regs.F.C = ((regs.L) & 0x80) >>> 7; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.L) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x112: new SM83_opcode_functions(SM83_opcode_matrixCB[0x10], // CB 10
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let carry = ((regs.B) & 0x80) >>> 7; // DELAYED
                regs.B = (((regs.B) << 1) & 0xFE) | regs.F.C; // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.B) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x113: new SM83_opcode_functions(SM83_opcode_matrixCB[0x11], // CB 11
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let carry = ((regs.C) & 0x80) >>> 7; // DELAYED
                regs.C = (((regs.C) << 1) & 0xFE) | regs.F.C; // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.C) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x114: new SM83_opcode_functions(SM83_opcode_matrixCB[0x12], // CB 12
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let carry = ((regs.D) & 0x80) >>> 7; // DELAYED
                regs.D = (((regs.D) << 1) & 0xFE) | regs.F.C; // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.D) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x115: new SM83_opcode_functions(SM83_opcode_matrixCB[0x13], // CB 13
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let carry = ((regs.E) & 0x80) >>> 7; // DELAYED
                regs.E = (((regs.E) << 1) & 0xFE) | regs.F.C; // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.E) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x116: new SM83_opcode_functions(SM83_opcode_matrixCB[0x14], // CB 14
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let carry = ((regs.H) & 0x80) >>> 7; // DELAYED
                regs.H = (((regs.H) << 1) & 0xFE) | regs.F.C; // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.H) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x117: new SM83_opcode_functions(SM83_opcode_matrixCB[0x15], // CB 15
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                let carry = ((regs.L) & 0x80) >>> 7; // DELAYED
                regs.L = (((regs.L) << 1) & 0xFE) | regs.F.C; // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.L) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x11A: new SM83_opcode_functions(SM83_opcode_matrixCB[0x18], // CB 18
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                ...
                regs.B = ((regs.B) >>> 1) | (regs.F.C << 7); // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.B) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x11B: new SM83_opcode_functions(SM83_opcode_matrixCB[0x19], // CB 19
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                ...
                regs.C = ((regs.C) >>> 1) | (regs.F.C << 7); // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.C) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x11C: new SM83_opcode_functions(SM83_opcode_matrixCB[0x1A], // CB 1A
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                ...
                regs.D = ((regs.D) >>> 1) | (regs.F.C << 7); // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.D) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x11D: new SM83_opcode_functions(SM83_opcode_matrixCB[0x1B], // CB 1B
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                ...
                regs.E = ((regs.E) >>> 1) | (regs.F.C << 7); // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.E) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x11E: new SM83_opcode_functions(SM83_opcode_matrixCB[0x1C], // CB 1C
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                ...
                regs.H = ((regs.H) >>> 1) | (regs.F.C << 7); // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.H) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x11F: new SM83_opcode_functions(SM83_opcode_matrixCB[0x1D], // CB 1D
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                ...
                regs.L = ((regs.L) >>> 1) | (regs.F.C << 7); // DELAYED
                regs.F.C = carry; // DELAYED
                regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.L) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
    ...
    0x132: new SM83_opcode_functions(SM83_opcode_matrixCB[0x30], // CB 30
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.B = (((regs.B) << 4) | ((regs.B) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.B) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
                regs.PC = (regs.PC + 1) & 0xFFFF;
    ...
    0x133: new SM83_opcode_functions(SM83_opcode_matrixCB[0x31], // CB 31
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.C = (((regs.C) << 4) | ((regs.C) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.C) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x134: new SM83_opcode_functions(SM83_opcode_matrixCB[0x32], // CB 32
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.D = (((regs.D) << 4) | ((regs.D) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.D) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x135: new SM83_opcode_functions(SM83_opcode_matrixCB[0x33], // CB 33
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.E = (((regs.E) << 4) | ((regs.E) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.E) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x136: new SM83_opcode_functions(SM83_opcode_matrixCB[0x34], // CB 34
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.H = (((regs.H) << 4) | ((regs.H) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.H) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x137: new SM83_opcode_functions(SM83_opcode_matrixCB[0x35], // CB 35
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.L = (((regs.L) << 4) | ((regs.L) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.L) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x138: new SM83_opcode_functions(SM83_opcode_matrixCB[0x36], // CB 36
        ...
        switch(regs.TCU) {
            ...
            case 2: // Do write
                regs.TR = pins.D; // DELAYED
                regs.TR = (((regs.TR) << 4) | ((regs.TR) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.TR) === 0); // DELAYED
                pins.Addr = (regs.TA);
                pins.D = regs.TR;
    ...
    0x139: new SM83_opcode_functions(SM83_opcode_matrixCB[0x37], // CB 37
        ...
        switch(regs.TCU) {
            case 1: // cleanup_custom
                regs.A = (((regs.A) << 4) | ((regs.A) >>> 4)) & 0xFF; // DELAYED
                regs.F.C = regs.F.H = regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.A) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
    ...
    0x180: new SM83_opcode_functions(SM83_opcode_matrixCB[0x7E], // CB 7E
        ...
        switch(regs.TCU) {
            ...
            case 2: // cleanup_custom
                ...
                regs.F.H = 1; // DELAYED
                regs.F.N = 0; // DELAYED
                regs.F.Z = +((regs.TR & 128) === 0); // DELAYED
                // Following is auto-generated code for instruction finish // DELAYED
                pins.Addr = regs.PC;
                regs.PC = (regs.PC + 1) & 0xFFFF;
                regs.TCU = 0;
