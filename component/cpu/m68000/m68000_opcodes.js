...
const M68K_MN = Object.freeze({
    ...
    MOVEM_TO_MEM: 150, MOVEM_TO_MEM_W: 151, MOVEM_TO_MEM_L: 152, MOVEM_TO_RG: 153, MOVEM_TO_RG_W: 154,
    MOVEM_TO_RG_L: 155, MOVEP: 156, MOVEP_W_DR_EA: 157, MOVEP_L_DR_EA: 158, MOVEP_W_EA_DR: 159,
    MOVEP_L_EA_DR: 160, MOVEQ: 161, MULS: 162, MULU: 163, NBCD: 164,
    NEG: 165, NEG_B: 166, NEG_W: 167, NEG_L: 168, NEGX: 169,
    NEGX_B: 170, NEGX_W: 171, NEGX_L: 172, NOP: 173, NOT: 174,
    NOT_B: 175, NOT_W: 176, NOT_L: 177, OR: 178, OR_B_EA_DR: 179,
    OR_W_EA_DR: 180, OR_L_EA_DR: 181, OR_B_DR_EA: 182, OR_W_DR_EA: 183, OR_L_DR_EA: 184,
    ORI: 185, ORI_B: 186, ORI_W: 187, ORI_L: 188, ORI_TO_CCR: 189,
    ORI_TO_SR: 190, PEA: 191, RESET: 192, ROL: 193, ROL_B_IMM: 194,
    ROL_W_IMM: 195, ROL_L_IMM: 196, ROL_B_REG: 197, ROL_W_REG: 198, ROL_L_REG: 199,
    ROL_EA: 200, ROR: 201, ROR_B_IMM: 202, ROR_W_IMM: 203, ROR_L_IMM: 204,
    ROR_B_REG: 205, ROR_W_REG: 206, ROR_L_REG: 207, ROR_EA: 208, ROXL: 209,
    ROXL_B_IMM: 210, ROXL_W_IMM: 211, ROXL_L_IMM: 212, ROXL_B_REG: 213, ROXL_W_REG: 214,
    ROXL_L_REG: 215, ROXL_EA: 216, ROXR: 217, ROXR_B_IMM: 218, ROXR_W_IMM: 219,
    ROXR_L_IMM: 220, ROXR_B_REG: 221, ROXR_W_REG: 222, ROXR_L_REG: 223, ROXR_EA: 224,
    RTE: 225, RTR: 226, RTS: 227, SBCD: 228, SCC: 229,
    STOP: 230, SUB: 231, SUB_B_EA_DR: 232, SUB_W_EA_DR: 233, SUB_L_EA_DR: 234,
    SUB_B_DR_EA: 235, SUB_W_DR_EA: 236, SUB_L_DR_EA: 237, SUBA: 238, SUBA_W: 239,
    SUBA_L: 240, SUBI: 241, SUBI_B: 242, SUBI_W: 243, SUBI_L: 244,
    SUBQ: 245, SUBQ_B_IMM_EA: 246, SUBQ_W_IMM_EA: 247, SUBQ_L_IMM_EA: 248, SUBQ_W_IMM_AR: 249,
    SUBQ_L_IMM_AR: 250, SUBX: 251, SUBX_B: 252, SUBX_W: 253, SUBX_L: 254,
    SWAP: 255, TAS: 256, TRAP: 257, TRAPV: 258, TST: 259,
    TST_B: 260, TST_W: 261, TST_L: 262, UNLK: 263,
});
...
const M68K_MN_R = Object.freeze({
    ...
    150: 'MOVEM_TO_MEM', 151: 'MOVEM_TO_MEM_W', 152: 'MOVEM_TO_MEM_L', 153: 'MOVEM_TO_RG', 154: 'MOVEM_TO_RG_W',
    155: 'MOVEM_TO_RG_L', 156: 'MOVEP', 157: 'MOVEP_W_DR_EA', 158: 'MOVEP_L_DR_EA', 159: 'MOVEP_W_EA_DR',
    160: 'MOVEP_L_EA_DR', 161: 'MOVEQ', 162: 'MULS', 163: 'MULU', 164: 'NBCD',
    165: 'NEG', 166: 'NEG_B', 167: 'NEG_W', 168: 'NEG_L', 169: 'NEGX',
    170: 'NEGX_B', 171: 'NEGX_W', 172: 'NEGX_L', 173: 'NOP', 174: 'NOT',
    175: 'NOT_B', 176: 'NOT_W', 177: 'NOT_L', 178: 'OR', 179: 'OR_B_EA_DR',
    180: 'OR_W_EA_DR', 181: 'OR_L_EA_DR', 182: 'OR_B_DR_EA', 183: 'OR_W_DR_EA', 184: 'OR_L_DR_EA',
    185: 'ORI', 186: 'ORI_B', 187: 'ORI_W', 188: 'ORI_L', 189: 'ORI_TO_CCR',
    190: 'ORI_TO_SR', 191: 'PEA', 192: 'RESET', 193: 'ROL', 194: 'ROL_B_IMM',
    195: 'ROL_W_IMM', 196: 'ROL_L_IMM', 197: 'ROL_B_REG', 198: 'ROL_W_REG', 199: 'ROL_L_REG',
    200: 'ROL_EA', 201: 'ROR', 202: 'ROR_B_IMM', 203: 'ROR_W_IMM', 204: 'ROR_L_IMM',
    205: 'ROR_B_REG', 206: 'ROR_W_REG', 207: 'ROR_L_REG', 208: 'ROR_EA', 209: 'ROXL',
    210: 'ROXL_B_IMM', 211: 'ROXL_W_IMM', 212: 'ROXL_L_IMM', 213: 'ROXL_B_REG', 214: 'ROXL_W_REG',
    215: 'ROXL_L_REG', 216: 'ROXL_EA', 217: 'ROXR', 218: 'ROXR_B_IMM', 219: 'ROXR_W_IMM',
    220: 'ROXR_L_IMM', 221: 'ROXR_B_REG', 222: 'ROXR_W_REG', 223: 'ROXR_L_REG', 224: 'ROXR_EA',
    225: 'RTE', 226: 'RTR', 227: 'RTS', 228: 'SBCD', 229: 'SCC',
    230: 'STOP', 231: 'SUB', 232: 'SUB_B_EA_DR', 233: 'SUB_W_EA_DR', 234: 'SUB_L_EA_DR',
    235: 'SUB_B_DR_EA', 236: 'SUB_W_DR_EA', 237: 'SUB_L_DR_EA', 238: 'SUBA', 239: 'SUBA_W',
    240: 'SUBA_L', 241: 'SUBI', 242: 'SUBI_B', 243: 'SUBI_W', 244: 'SUBI_L',
    245: 'SUBQ', 246: 'SUBQ_B_IMM_EA', 247: 'SUBQ_W_IMM_EA', 248: 'SUBQ_L_IMM_EA', 249: 'SUBQ_W_IMM_AR',
    250: 'SUBQ_L_IMM_AR', 251: 'SUBX', 252: 'SUBX_B', 253: 'SUBX_W', 254: 'SUBX_L',
    255: 'SWAP', 256: 'TAS', 257: 'TRAP', 258: 'TRAPV', 259: 'TST',
    260: 'TST_B', 261: 'TST_W', 262: 'TST_L', 263: 'UNLK',
});
